...
{
    public abstract class AbstractDbConfigurationSource : IDbConfigurationSource
    {
        ...
        protected AbstractDbConfigurationSource(IConfigurationBuilder configurationBuilder)
