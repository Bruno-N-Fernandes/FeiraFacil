...
namespace ConsoleApp
{
    public static class BoxFactory
    {
        public static IBox CreateBoxPedido()
        {
            ...
            tabela.Add(-22, "Cliente ", x => $"{x.Cliente.Nome}");
            tabela.Add(-80, "Produtos", x => string.Join("; ", x.Items.Select(i => $"{i.Quantidade} {i.Produto.Nome}")));
            return tabela;
        }
        ...
        public static IBox CreateBoxProduto()
        {
            ...
            tabela.Add(007, "Estoque", x => $"{x.Estoque:0.000}");
